...
;
;Input:
; - $00 to $01 (16-bit): The quantity
; - $02 to $03 (16-bit): The minimal quantity
; - $04 to $05 (16-bit): The maximal quantity
;Output:
; - $00 to $01 (16-bit): The quantity, after subtracted by minimal quantity
;                        (If quantity is < MIN, then return 0). Essentially
;                        how much from the minimum
; - $02 to $03 (16-bit): The minimal quantity (same number as entered before)
; - $04 to $05 (16-bit): The maximal quantity (subtracted by minimal quantity).
...
;Input:
; - $00 to $01 (16-bit): The quantity
; - $02 to $03 (16-bit): The max quantity
;Output:
; - $00 to $01 (16-bit): The inverted quantity (InvertedQuantity = max(MaxQuantity - Quantity, 0))
; - $02 to $03 (16-bit): The max quantity (unchanged)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
InvertQuantity:
	REP #$20
